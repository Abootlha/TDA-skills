            ...
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 flex flex-col gap-6 relative overflow-hidden">
                ...
                {!createdBookingId ? (
                    <div className="flex justify-between items-center mt-8 pt-8 border-t border-gray-100">
                        <button onClick={onBack} className="text-[#001430] font-bold text-sm hover:underline px-4 py-2">
                            Return to Cart
                        </button>
                        <button onClick={handleCreateBooking} disabled={isSubmitting} className="bg-[#ffbb16] text-[#001430] hover:bg-[#f2b012] px-10 py-4 rounded-xl font-bold flex items-center gap-3 transition-all transform hover:-translate-y-0.5 shadow-lg shadow-[#ffbb16]/20 disabled:opacity-50 disabled:transform-none disabled:shadow-none text-lg">
