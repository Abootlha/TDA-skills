...
export default function AdminCITBTestsPage() {
    return (
        <div className="space-y-6 animate-in fade-in zoom-in duration-300">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div>
                    <h1 className="text-2xl font-bold text-[#001430]">CITB Test Bookings</h1>
                    <p className="text-gray-500 text-sm mt-1">Manage Health, Safety & Environment test types and pricing.</p>
                </div>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                <td className="px-6 py-4">
                                    <div className="font-semibold text-[#001430]">HS&E Test for Operatives</div>
                                </td>
                                <td className="px-6 py-4 text-sm text-gray-600">Standard test for general site workers.</td>
                                <td className="px-6 py-4 text-sm font-semibold text-[#001430]">£22.50</td>
                                <td className="px-6 py-4">
                            ...
                            <tr className="hover:bg-gray-50/50 transition-colors">
                                <td className="px-6 py-4">
                                    <div className="font-semibold text-[#001430]">HS&E Test for Managers & Professionals (MAP)</div>
                                </td>
                                <td className="px-6 py-4 text-sm text-gray-600">Advanced test for site managers.</td>
                                <td className="px-6 py-4 text-sm font-semibold text-[#001430]">£22.50</td>
                                <td className="px-6 py-4">
                                    <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                        Active
